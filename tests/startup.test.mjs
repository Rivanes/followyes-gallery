...
const index = fs.readFileSync(new URL('../gallery/index.html', import.meta.url), 'utf8');
const source = fs.readFileSync(new URL('../src/gallery-engine.js', import.meta.url), 'utf8');
...
assert.ok(bootstrap.includes('const engineModule = await import(`../gallery-engine.min.js?v=${ENGINE_CACHE_KEY}`)'));
