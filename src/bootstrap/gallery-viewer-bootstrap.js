/*
  Berryboy Art Gallery — Stage 12C63B Image-First Startup Queue
  Public bootstrap. Editor/auth actions are dynamically imported only when needed.
*/

import { createClient } from "https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";
import { createScene } from "../Gallery_V0_11.min.js?v=stage12c63b_image_first_startup_queue_20260713";
...
async function loadEditorModule() {
  if (!editorModulePromise) {
    editorModulePromise = import("./gallery-editor-bootstrap.js?v=stage12c63b").then(function (module) {
