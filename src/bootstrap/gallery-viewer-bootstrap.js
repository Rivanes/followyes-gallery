/*
  Berryboy Art Gallery — Stage 12C63 Full Fast Start Architecture
  Public bootstrap. Editor/auth actions are dynamically imported only when needed.
*/

import { createClient } from "https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";
import { createScene } from "../Gallery_V0_11.min.js?v=stage12c63_full_fast_start_20260712";
...
async function loadEditorModule() {
  if (!editorModulePromise) {
    editorModulePromise = import("./gallery-editor-bootstrap.js?v=stage12c63").then(function (module) {
