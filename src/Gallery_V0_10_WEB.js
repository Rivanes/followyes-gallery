...
export const createScene = function (engineArg, canvasArg) {
    ...
    async function loadWebGalleryStateFromSupabase() {
        ...
        if (
            ...
            applyWebGalleryState(response.data.state);
            notifyGalleryStatus("Saved gallery state loaded.");
            return true;
        }
    ...
    async function saveWebGalleryStateToSupabase() {
        ...
        notifyGalleryStatus("Gallery state saved online.");
        return true;
    }
