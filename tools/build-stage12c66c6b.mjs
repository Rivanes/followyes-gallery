...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66C6B_AVIF_PIPELINE_MIGRATION_WEBP_REMOVAL_LOGIN_DISABLED.txt');
...
console.log(`Stage 12C66C6B AVIF Pipeline / Migration / WebP Removal production build generated (${(ratio * 100).toFixed(1)}% of source size).`);
