...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66C6C6_ARTWORK_FRAME_RUNTIME_PERFORMANCE_LOGIN_DISABLED.txt');
...
console.log(`Stage 12C66C6C6 production build generated (${(production.length / source.length * 100).toFixed(1)}% of source size).`);
