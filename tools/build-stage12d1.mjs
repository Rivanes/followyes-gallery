...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12D1_VENUE_AGNOSTIC_ENGINE_BUILDING_MANIFEST_LOGIN_DISABLED.txt');
...
console.log(`Stage 12D1 production build generated (${(production.length / source.length * 100).toFixed(1)}% of source size).`);
