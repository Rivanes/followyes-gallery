...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66C6B1_EXISTING_AUTHOR_AVIF_RECONCILIATION_LOGIN_DISABLED.txt');
...
console.log(`Stage 12C66C6B1 Existing Author AVIF Reconciliation production build generated (${(ratio * 100).toFixed(1)}% of source size).`);
