...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-3-scene-ownership-hardening') && viewer.includes('const STAGE = "V14.1.3"') && admin.includes('const STAGE = "V14.1.3"'));
...
expect('package identity', pkg.version.includes('v14-1-3-scene-ownership-hardening'));
...
expect("package stage", pkg.version.includes("v14-1-3-scene-ownership-hardening"));
