...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-10-no-reload-residency-frame-time') && viewer.includes('const STAGE = "V14.1.10"') && admin.includes('const STAGE = "V14.1.10"'));
...
expect('package identity', pkg.version.includes('v14-1-10-no-reload-residency-frame-time'));
...
expect("package stage", pkg.version.includes("v14-1-10-no-reload-residency-frame-time"));
