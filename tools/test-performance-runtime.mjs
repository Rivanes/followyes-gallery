...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-4-gallery-authoring-assigned-space-settle') && viewer.includes('const STAGE = "V14.1.4"') && admin.includes('const STAGE = "V14.1.4"'));
...
expect('package identity', pkg.version.includes('v14-1-4-gallery-authoring-assigned-space-settle'));
...
expect("package stage", pkg.version.includes("v14-1-4-gallery-authoring-assigned-space-settle"));
