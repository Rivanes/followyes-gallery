...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-6-shared-runtime-host') && viewer.includes('const STAGE = "V14.1.6"') && admin.includes('const STAGE = "V14.1.6"'));
...
expect('package identity', pkg.version.includes('v14-1-6-shared-runtime-host'));
...
expect("package stage", pkg.version.includes("v14-1-6-shared-runtime-host"));
