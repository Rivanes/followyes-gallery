...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-2-scene-loading-orchestrator') && viewer.includes('const STAGE = "V14.1.2"') && admin.includes('const STAGE = "V14.1.2"'));
...
expect('package identity', pkg.version.includes('v14-1-2-scene-loading-orchestrator'));
...
expect("package stage", pkg.version.includes("v14-1-2-scene-loading-orchestrator"));
