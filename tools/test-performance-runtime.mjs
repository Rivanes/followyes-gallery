...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v13-shared-asset-foundation') && viewer.includes('const STAGE = "V13.1"') && admin.includes('const STAGE = "V13.1"'));
...
expect('package identity', pkg.version.includes('v13-shared-asset-foundation'));
...
expect("package stage", pkg.version.includes("v13-shared-asset-foundation"));
