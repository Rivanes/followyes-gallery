...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v13-frame-browser-migration') && viewer.includes('const STAGE = "V13.4"') && admin.includes('const STAGE = "V13.4"'));
