...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v13-reference-runtime-hardening') && viewer.includes('const STAGE = "V13.5"') && admin.includes('const STAGE = "V13.5"'));
