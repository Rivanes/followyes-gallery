...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-5-admin-visible-hydration-batch') && viewer.includes('const STAGE = "V14.1.5"') && admin.includes('const STAGE = "V14.1.5"'));
...
expect('package identity', pkg.version.includes('v14-1-5-admin-visible-hydration-batch'));
...
expect("package stage", pkg.version.includes("v14-1-5-admin-visible-hydration-batch"));
