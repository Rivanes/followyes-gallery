...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-10-1-public-fresh-visit-reentry') && viewer.includes('const STAGE = "V14.1.10.1"') && admin.includes('const STAGE = "V14.1.10.1"'));
...
expect('package identity', pkg.version.includes('v14-1-10-1-public-fresh-visit-reentry'));
...
expect("package stage", pkg.version.includes("v14-1-10-1-public-fresh-visit-reentry"));
