...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-1-scene-loading-policies') && viewer.includes('const STAGE = "V14.1.1"') && admin.includes('const STAGE = "V14.1.1"'));
...
expect('package identity', pkg.version.includes('v14-1-1-scene-loading-policies'));
...
expect("package stage", pkg.version.includes("v14-1-1-scene-loading-policies"));
