...
expect('current package keeps transition guard regression coverage', pkg.version.includes('c6c8c24') && viewer.includes('const STAGE = "C6C8C24"') && admin.includes('const STAGE = "C6C8C24"'));
...
expect('package identity', pkg.version.includes('c6c8c24'));
...
expect("package stage", pkg.version.includes("c6c8c24"));
