...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v14-1-5-1-glb-runtime-truth') && viewer.includes('const STAGE = "V14.1.5.1"') && admin.includes('const STAGE = "V14.1.5.1"'));
...
expect('package identity', pkg.version.includes('v14-1-5-1-glb-runtime-truth'));
...
expect("package stage", pkg.version.includes("v14-1-5-1-glb-runtime-truth"));
