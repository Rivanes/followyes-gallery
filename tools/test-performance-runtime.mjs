...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v13-left-workspace-asset-manager') && viewer.includes('const STAGE = "V13.2"') && admin.includes('const STAGE = "V13.2"'));
