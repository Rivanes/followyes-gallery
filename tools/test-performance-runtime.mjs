...
expect('current package keeps transition guard regression coverage', pkg.version.includes('c6c8c22') && viewer.includes('const STAGE = "C6C8C22"') && admin.includes('const STAGE = "C6C8C22"'));
