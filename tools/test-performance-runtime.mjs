...
expect('current package keeps transition guard regression coverage', pkg.version.includes('v13-prop-browser-placement') && viewer.includes('const STAGE = "V13.3"') && admin.includes('const STAGE = "V13.3"'));
