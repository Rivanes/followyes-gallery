...
expect('current package stage', pkg.version.includes('v14-1-2-scene-loading-orchestrator'));
...
assert.equal(pkg.version, '0.14.1-v14-1-2-scene-loading-orchestrator');
