...
expect('current package stage', pkg.version.includes('v14-1-4-gallery-authoring-assigned-space-settle'));
...
assert.equal(pkg.version, '0.14.1-v14-1-4-gallery-authoring-assigned-space-settle');
