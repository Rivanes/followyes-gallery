...
expect('current package keeps transition guard regression coverage', pkg.version.includes('c6c8c13') && viewer.includes('const STAGE = "12C66C6C8C13"') && admin.includes('const STAGE = "12C66C6C8C13"'));
