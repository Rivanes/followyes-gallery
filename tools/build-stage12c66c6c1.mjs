...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66C6C1_CANONICAL_VISUAL_STATE_MOBILE_LIGHTING_REFLECTION_PARITY_LOGIN_DISABLED.txt');
...
console.log(`Stage 12C66C6C1 production build generated (${(production.length / source.length * 100).toFixed(1)}% of source size).`);
