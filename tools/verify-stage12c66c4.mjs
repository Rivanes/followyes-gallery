...
const txt = fs.readFileSync(new URL('../Gallery_V0_11_STAGE12C66C4_SCULPTURE_CORE_REBUILD_LOGIN_DISABLED.txt', import.meta.url), 'utf8');
...
assert(index.includes('stage: "12C66C4"'), 'Boot Guard Stage 12C66C4 identity missing');
assert(source.includes('Stage 12C66C4: Sculpture Core Rebuild'), 'Stage 12C66C4 source history missing');
assert(source.includes('stage: "12C65E"'), 'Protected Stage 12C65E streaming runtime identity missing');
assert(source.includes('stage: "12C66C4"'), 'Stage 12C66C4 save-integrity runtime identity missing');
assert(bootstrap.includes('Stage 12C66C4'), 'Viewer bootstrap Stage 12C66C4 label missing');
assert(bootstrap.includes('stage12c66c4_sculpture_core_rebuild_20260724'), 'Stage 12C66C4 engine cache key missing');
assert(index.includes('gallery-viewer-bootstrap.js?v=stage12c66c4_sculpture_core_rebuild_20260724'), 'Page bootstrap Stage 12C66C4 cache key missing');
assert(bootstrap.includes('const STAGE = "12C66C4"'), 'Viewer runtime Stage 12C66C4 identity missing');
assert(editorBootstrap.includes('Stage 12C66C4'), 'Editor bootstrap Stage 12C66C4 label missing');
...
// Stage 12C66C4 save-integrity repair contract.
...
// Stage 12C66C4 sculpture core rebuild contract.
...
assert(minified.includes('12C66C4'), 'Production Stage 12C66C4 identity missing');
...
console.log('Stage 12C66C4 verifier passed.');
