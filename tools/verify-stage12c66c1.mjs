...
const txt = fs.readFileSync(new URL('../Gallery_V0_11_STAGE12C66C1_INPUT_UI_HOTFIX_LOGIN_DISABLED.txt', import.meta.url), 'utf8');
...
assert(index.includes('stage: "12C66C1"'), 'Boot Guard Stage 12C66C1 identity missing');
assert(source.includes('Stage 12C66C1: Input / HUD Polish Hotfix'), 'Stage 12C66C1 source history missing');
assert(source.includes('stage: "12C65E"'), 'Protected Stage 12C65E streaming runtime identity missing');
assert(source.includes('stage: "12C66C1"'), 'Stage 12C66C1 save-integrity runtime identity missing');
assert(bootstrap.includes('Stage 12C66C1'), 'Viewer bootstrap Stage 12C66C1 label missing');
assert(bootstrap.includes('stage12c66c1_input_ui_hotfix_20260723'), 'Stage 12C66C1 engine cache key missing');
assert(index.includes('gallery-viewer-bootstrap.js?v=stage12c66c1_input_ui_hotfix_20260723'), 'Page bootstrap Stage 12C66C1 cache key missing');
assert(bootstrap.includes('const STAGE = "12C66C1"'), 'Viewer runtime Stage 12C66C1 identity missing');
assert(editorBootstrap.includes('Stage 12C66C1'), 'Editor bootstrap Stage 12C66C1 label missing');
...
// Stage 12C66C1 save-integrity repair contract.
...
// Stage 12C66C1 input, editor workflow and collision contract.
...
assert(source.includes('galleryFloorCursorRingMaterial.alpha = 0.90'), 'Floor cursor visibility boost missing');
...
assert(minified.includes('12C66C1'), 'Production Stage 12C66C1 identity missing');
...
console.log('Stage 12C66C1 verifier passed.');
