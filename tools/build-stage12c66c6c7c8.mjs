...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66C6C7C8_SPACE_EXHIBITION_MULTI_LOGIN_DISABLED.txt');
...
// The engine-only TXT does not run gallery-viewer-bootstrap.js, so inject the same
// external Space definition as a global before the engine source.
const loginDisabled =
...
console.log(`Stage 12C66C6C7C8 production build generated (${(production.length / source.length * 100).toFixed(1)}% of source size).`);
