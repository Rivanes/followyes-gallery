...
expect('current release package is V14.1.6', pkg.version.includes('v14-1-6-shared-runtime-host'));
expect('Admin release identity is V14.1.6', admin.includes('const STAGE = "V14.1.6"'));
