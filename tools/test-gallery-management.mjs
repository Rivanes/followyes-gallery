...
expect('current release package is V14.1.10', pkg.version.includes('v14-1-10-no-reload-residency-frame-time'));
expect('Admin release identity is V14.1.10', admin.includes('const STAGE = "V14.1.10"'));
