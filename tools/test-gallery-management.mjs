...
expect('release package is V13.3 Prop Browser + Exhibition Placement', pkg.version.includes('v13-prop-browser-placement'));
expect('Admin release identity is V13.3', admin.includes('const STAGE = "V13.3"'));
...
console.log('C6C8C22 Gallery Management regression invariants passed under V13.3.');
