...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66C6C8C_ASSET_RESIDENCY_EGRESS_GUARD_LOGIN_DISABLED.txt');
...
console.log(`Stage 12C66C6C8C production build generated (${(production.length / source.length * 100).toFixed(1)}% of source size).`);
