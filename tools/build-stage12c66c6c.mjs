...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66C6C_ATOMIC_AVIF_MEDIA_LIFECYCLE_MOBILE_SCENE_QUALITY_PARITY_LOGIN_DISABLED.txt');
...
console.log(`Stage 12C66C6C production build generated (${(production.length / source.length * 100).toFixed(1)}% of source size).`);
