...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12D2_MULTI_VENUE_MULTI_EXHIBITION_LOGIN_DISABLED.txt');
...
console.log(`Stage 12D2 production build generated (${(production.length / source.length * 100).toFixed(1)}% of source size).`);
