...
const txt = fs.readFileSync(new URL('../Gallery_V0_11_STAGE12C66A_SAVE_INTEGRITY_LOGIN_DISABLED.txt', import.meta.url), 'utf8');
...
assert(index.includes('Stage 12C66A'), 'Index Stage 12C66A label missing');
assert(index.includes('stage: "12C66A"'), 'Boot Guard Stage 12C66A identity missing');
assert(source.includes('Stage 12C66A: Save Integrity / Draft Commit / Deferred Storage Cleanup'), 'Stage 12C66A source history missing');
...
assert(bootstrap.includes('Stage 12C66A Save Integrity / Draft Commit / Deferred Storage Cleanup'), 'Viewer bootstrap Stage 12C66A label missing');
assert(bootstrap.includes('stage12c66a_save_integrity_20260723'), 'Stage 12C66A engine cache key missing');
assert(index.includes('gallery-viewer-bootstrap.js?v=stage12c66a_save_integrity_20260723'), 'Page bootstrap Stage 12C66A cache key missing');
assert(bootstrap.includes('stage: "12C66A"'), 'Viewer runtime Stage 12C66A identity missing');
assert(editorBootstrap.includes('Stage 12C66A'), 'Editor bootstrap Stage 12C66A label missing');
...
assert(minified.includes('12C66A'), 'Production mirror Stage 12C66A identity missing');
...
console.log('Stage 12C66A verifier passed.');
