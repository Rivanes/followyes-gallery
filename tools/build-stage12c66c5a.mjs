...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66C5A_UNIFIED_GROUND_COLLISION_LOGIN_DISABLED.txt');
...
console.log(`Stage 12C66C5A production build generated (${(ratio * 100).toFixed(1)}% of source size).`);
