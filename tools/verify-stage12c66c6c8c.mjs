...
const txt=fs.readFileSync(new URL('../Gallery_V0_11_STAGE12C66C6C8C_ASSET_RESIDENCY_EGRESS_GUARD_LOGIN_DISABLED.txt',import.meta.url),'utf8');
...
assert(index.includes('stage: "12C66C6C8C"'),'Index stage identity missing');
assert(bootstrap.includes('const STAGE = "12C66C6C8C"'),'Bootstrap stage identity missing');
assert(bootstrap.includes('stage12c66c6c8c_asset_residency_20260812'),'C6C7/C6C8 cache key missing');
assert(index.includes('gallery-viewer-bootstrap.js?v=stage12c66c6c8c_asset_residency_20260812'),'Index cache key missing');
assert(editorBootstrap.includes('Stage 12C66C6C8C'),'Editor bootstrap label missing');
...
assert(assetCacheBootstrap.includes('SERVICE_WORKER_URL')&&assetCacheSw.includes('exhibition-platform-assets-c6c8c-20260812'),'Asset cache service worker missing');
...
console.log('Stage 12C66C6C8C verifier passed.');
