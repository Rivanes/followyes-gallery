...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66C6A_MOBILE_QUALITY_FOUNDATION_LOGIN_DISABLED.txt');
...
console.log(`Stage 12C66C6A Mobile Quality Foundation production build generated (${(ratio * 100).toFixed(1)}% of source size).`);
