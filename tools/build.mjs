...
const sourcePath = path.join(root, 'src', 'gallery-engine.js');
const productionPath = path.join(root, 'src', 'gallery-engine.min.js');
...
console.log(`Production gallery engine generated (${(production.length / source.length * 100).toFixed(1)}% of source size).`);
