...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66C6A1_INSPECT_TRANSITION_COMPACT_MOBILE_LOGIN_DISABLED.txt');
...
console.log(`Stage 12C66C6A1 Inspect Transition Isolation / Compact Mobile Inspect UI production build generated (${(ratio * 100).toFixed(1)}% of source size).`);
