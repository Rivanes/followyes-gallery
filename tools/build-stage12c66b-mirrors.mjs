...
const loginDisabledPath = path.join(root, 'Gallery_V0_11_STAGE12C66B_SINGLE_STARTUP_CLEAN_VIEWER_LOGIN_DISABLED.txt');
...
// Stage 12C66B keeps a byte-identical production mirror to prevent source/runtime drift.
...
console.log('Stage 12C66B production mirror and login-disabled TXT regenerated.');
